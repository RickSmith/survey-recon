...
**Screened on** 2026-09-19. **Reference** `texas-bexar-sh0016-kg-20260919T122630`.
...
*Built from `texas-bexar-sh0016-kg-20260919T122630` by corridor-screen 0.1.0. Every figure above is read from that run, and every answer that run received is saved with the date it was obtained — the screening file beside this memo says which.*
