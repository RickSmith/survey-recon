...
!!! note "It is a frame, not a talk"
    ...
    hours, and outline slides under each. **3 of them are still placeholders**,
    ...
    [issue #12](https://github.com/RickSmith/survey-recon/issues/12). Nine
    ...
    three slides read back out of the document it frames; and the review,
    seal and three failures under
    ...
    beats were built from. The close is the rest, under
    [#86](https://github.com/RickSmith/survey-recon/issues/86).
