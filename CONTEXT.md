...
| **Short duration** | TxDOT's term, identical on all six TCP(S-\*) sheets: work that occupies a location **up to 1 hour**. Past it the work is *short term stationary* and the reliefs the hour bought lapse |
