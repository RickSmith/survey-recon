...
| **Job page** | What a screening run is to be handed over as: one file a surveyor sends to a principal, who reads it and runs nothing. Nearest thing in survey work is an exhibit — made for the person receiving it rather than for the file it came out of. **Not a "dashboard,"** which is a software word a principal would not use. **Nothing builds one yet**, and what goes on it is [issue #194](https://github.com/RickSmith/survey-recon/issues/194). Named while charting [issue #188](https://github.com/RickSmith/survey-recon/issues/188) |
